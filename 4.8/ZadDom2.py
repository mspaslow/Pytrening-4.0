...
elif film in archiwum:
    movie_list[film] = {'kategoria': archiwum[film]['kategoria'], 'rok': archiwum[film]['rok'], 'reżyser': archiwum[film]['reżyser']}
    del archiwum[film]
    print("Film przeniesiono z archiwum do bazy")
else:
